...
title: Orbit Of One
layout: post
post-image: "/assets/images/windamere.JPG"

description: Selected to showcase the first time-based artwork at Mudgee Arts Precint
tags:
- project
- animation
- HSC
permalink: /blog/orbit-of-one/
---



In 2025, there are 9 ARTEXPRESS exhibitions showcasing 228 incredible artworks, all chosen from over 8,800 submissions to the 2024 HSC. To be one of those selected is both incredibly humbling and deeply rewarding—and seeing it presented in the virtual space today really made the whole experience feel complete.
* [ArtExpress Bodies of Work 2024-25](https://artsunit.nsw.edu.au/program/artexpress/bodies-of-work)
* [Virtual Gallery 2025](https://www.artexpress.vr.artsunit.nsw.edu.au/2025/works/)
* [Mudgee Arts Precinct](https://www.mudgeeartsprecinct.com.au/WHATS-ON/Exhibition-Archive/ARTEXPRESS)
...
Orbit of One, a time-based 3D animation, is a cinematic exploration of memory and recollection. This highly sophisticated work utilises a range of emerging digital technologies to create a compelling narrative that takes the viewer on a biographical journey utilising an informed array of digital production tools. The rich use of visual symbolism dissolves between cropped close-ups and vast panoramas of the galaxy. The selected music track reinforces the film’s emotional storyline and allows the images to linger on screen. The locked off, static shots hold the viewer’s attention and amplify the minute details of the face and fingers. Technical choices including lens flare, focus blur and shallow depth of field lend an intimacy to the vast sense of wonder and great achievement told through the body of work.

**This is a link to the NSW Bodies Of Work for HSC 2024:**<br>
[ArtExpress NSW](https://artsunit.nsw.edu.au/program/artexpress/bodies-of-work)
